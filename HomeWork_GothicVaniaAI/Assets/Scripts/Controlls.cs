...
public class Controlls : MonoBehaviour {
	...
	[SerializeField] private KeyCode attackKeyBinding = attackKey;
	[SerializeField] private KeyCode jumpKeyBinding = jumpKey;
	[SerializeField] private KeyCode crouchKeyBinding = crouchKey;
